  ...
  return (
    <div className='flex min-h-screen flex-col items-center justify-center gap-1 rounded-md p-10'>
      ...
      >
        ...
        <button
          type='submit'
          className='w-full rounded-md bg-linear-to-r from-green-400 to-blue-500 px-4 py-2 font-semibold text-white transition-all duration-300 hover:from-green-500 hover:to-blue-600 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'
        >
          Register
        </button>
      </form>
